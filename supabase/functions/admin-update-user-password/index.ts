...
const handler = async (req: Request): Promise<Response> => {
  console.log('Admin update user password function called');
  ...
  try {
    ...
    const { userId, organizationId, password }: UpdatePasswordRequest = await req.json();
    ...
    // Update password in auth.users using service role key
