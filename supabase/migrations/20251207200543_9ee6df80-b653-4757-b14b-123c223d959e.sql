-- Update the create_organization_with_owner function to create correct onboarding steps
CREATE OR REPLACE FUNCTION public.create_organization_with_owner(_name text, _slug text, _user_id uuid, _template_id uuid DEFAULT NULL::uuid)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
