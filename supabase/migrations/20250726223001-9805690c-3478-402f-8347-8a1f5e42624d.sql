...
-- Add check constraint for source column if it doesn't exist
ALTER TABLE work_orders DROP CONSTRAINT IF EXISTS check_source;
...
DROP TABLE IF EXISTS turno_sync_log CASCADE;
CREATE TABLE turno_sync_log (
