...
CREATE TABLE public.places (
  ...
  latitude NUMERIC,
  longitude NUMERIC,
  location_text TEXT, -- general location description
...
INSERT INTO public.places (
  name, description, category, address, latitude, longitude, location_text,
...
SELECT 
  ...
  address, latitude, longitude, location as location_text,
  phone, website_url, rating, price_level, image_url,
  is_featured, is_active, display_order, created_at, updated_at, created_by
...
INSERT INTO public.places (
  name, description, category, location_text, image_url, activity_type,
...
SELECT 
  ...
  location as location_text, image_url, activity_type,
  is_featured, is_active, display_order, status, created_at, updated_at, created_by
