...
const TemplateOrganizations: React.FC<TemplateOrganizationsProps> = ({ 
  ...
  const handlePreview = (org: PlatformOrganization) => {
  ...
  const handleConfigure = (org: PlatformOrganization) => {
    // Navigate to organization settings - this would require switching context
