...
const EventImageUpload = ({ currentImageUrl, websiteUrl, onImageChange, disabled }: EventImageUploadProps) => {
  ...
  }, [uploadEventImage, onImageChange, disabled, uploading]);
    ...
    <div className="space-y-4">
      ...
      {currentImageUrl ? (
        ...
        <div
          ...
          onDrop={handleDrop}
          onClick={() => !disabled && !uploading && document.getElementById('event-image-input')?.click()}
        >
          <input
