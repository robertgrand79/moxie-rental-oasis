      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="text-center">
            ...
            <div className="text-lg font-bold text-gray-900">{property.max_guests}</div>
            <div className="text-sm text-gray-600">Guest{property.max_guests !== 1 ? 's' : ''}</div>
          </div>
        </div>
        ...
        {quickAmenities.length > 0 && (
          <div className="lg:hidden">
            <h3 className="text-sm font-semibold text-gray-700 mb-3">Popular Amenities</h3>
