  ...
  return (
    <div className="grid grid-cols-3 gap-6 pt-8 border-t border-border">
      <div className="text-center group">
        ...
        <h4 className="font-semibold text-foreground mb-1">Bedrooms</h4>
      ...
      <div className="text-center group">
        ...
        <h4 className="font-semibold text-foreground mb-1">Bathrooms</h4>
      ...
      <div className="text-center group">
        ...
        <h4 className="font-semibold text-foreground mb-1">Guests</h4>
