  ...
  return (
    <div className="py-24 relative">
      <div className="container mx-auto px-4">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-16 mx-auto border border-white/20 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {whatWeOffer.map((offer, index) => {
                ...
                return (
                  <div key={index} className="group bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg p-8 text-center border border-gray-100 hover:bg-white transition-all duration-300 hover:-translate-y-2">
