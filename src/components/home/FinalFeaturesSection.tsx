      ...
      <div className="container mx-auto px-4">
        <div className="bg-gray-900/95 backdrop-blur-xl rounded-3xl shadow-2xl p-16 mx-auto border border-white/20">
          <div className="text-center mb-20">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-gradient-accent-from to-gradient-accent-to mx-auto"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl p-10 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-br from-gradient-accent-from to-gradient-accent-to rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
