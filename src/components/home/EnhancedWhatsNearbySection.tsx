    ...
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        {filteredPOIs.some(poi => poi.is_featured) && (
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-foreground mb-4">Featured Recommendations</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {filteredPOIs.filter(poi => poi.is_featured).slice(0, 3).map((poi) => (
                <Card key={poi.id} className="border-2 border-primary/20 bg-primary/5">
                  <CardContent className="p-4">
                    ...
                    {poi.rating && (
                      <div className="flex items-center mt-1">
                        ...
                        <span className="text-xs text-muted-foreground">({poi.rating.toFixed(1)})</span>
                      </div>
                    )}
                  </CardContent>
                </Card>
            ...
            >
                ...
                <div className="relative overflow-hidden">
                  ...
                  {poi.is_featured && (
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-icon-amber text-foreground">Featured</Badge>
                    </div>
                  )}
                </div>
              )}
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  {poi.rating && (
                    <div className="flex items-center text-sm text-icon-amber">
                ...
                <div className="space-y-2 text-sm text-muted-foreground mb-4">
                  ...
                  {poi.price_level && (
                    <div className="flex items-center justify-between">
                      <span className="text-icon-emerald font-medium">
