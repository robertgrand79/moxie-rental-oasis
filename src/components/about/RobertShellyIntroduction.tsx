    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Left side - Magazine-style Photo Layout */}
          <div className="flex justify-center">
            <div className="w-full max-w-2xl">
              {/* Main hero photo - large and prominent */}
              <div className="mb-4">
                <div className="w-full h-80 overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                  <img 
              ...
              {/* Bottom row - three supporting photos */}
              <div className="grid grid-cols-3 gap-4">
                <div className="overflow-hidden rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <img 
