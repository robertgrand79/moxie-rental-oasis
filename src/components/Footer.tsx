          ...
          <div>
            ...
            <div className="flex space-x-4">
              {currentSettings.socialMedia?.facebook && (
                <a href={currentSettings.socialMedia.facebook} aria-label="Facebook" className="text-footer-muted hover:text-footer-foreground transition-colors">
                  <Facebook className="h-5 w-5" />
                </a>
              )}
              {currentSettings.socialMedia?.instagram && (
                <a href={currentSettings.socialMedia.instagram} aria-label="Instagram" className="text-footer-muted hover:text-footer-foreground transition-colors">
                  <Instagram className="h-5 w-5" />
                </a>
              )}
              {currentSettings.socialMedia?.twitter && (
                <a href={currentSettings.socialMedia.twitter} aria-label="Twitter" className="text-footer-muted hover:text-footer-foreground transition-colors">
