      ...
      <div className="relative">
        ...
        <div className="py-24 relative">
          <div className="container mx-auto px-4">
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-16 mb-16 border border-white/20 hover:shadow-3xl transition-all duration-300 group">
