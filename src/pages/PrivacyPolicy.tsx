          ...
          <div className="bg-card/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 mx-auto border border-border/20 max-w-4xl">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-foreground">
              ...
              <section>
                ...
                <h3 className="text-xl font-semibold mb-2">To process transactions</h3>
                <p className="mb-4">
                  Your information, whether public or private, will not be sold, exchanged, transferred, or given to any other company for any reason whatsoever, without your consent, other than for the express purpose of delivering the purchased product or service requested.
                </p>
                
                <h3 className="text-xl font-semibold mb-2">To send periodic emails</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">California Online Privacy Protection Act Compliance</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">Children's Online Privacy Protection Act Compliance</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">Personal, Financial, And Property Information</h2>
                <p className="mb-4">
